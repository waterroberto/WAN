  ...
  return (
    <Box
      ...
      sx={{
        ...
        overflow: "hidden",
        background:
          'url("https://firebasestorage.googleapis.com/v0/b/west-financial-services.appspot.com/o/happy-people.jpg?alt=media&token=42f33ad7-6dd4-4d82-8591-37e6652a9b94") no-repeat center center/cover',
